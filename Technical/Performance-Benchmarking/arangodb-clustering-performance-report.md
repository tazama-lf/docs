...
- [ArangoDB Clustering Performance Report](#arangodb-clustering-performance-report)
    ...
    - [Test Execution](#test-execution)
      ...
      - [3.	Write Operations Performance:](#3write-operations-performance)
      - [4.	Database Scaling:](#4database-scaling)
      - [5.	Performance Bottlenecks:](#5performance-bottlenecks)
      - [6.	Indexing Efficiency:](#6indexing-efficiency)
    - [Conclusions and Recommendations:](#conclusions-and-recommendations)
      - [To mitigate these issues, the following actions are recommended:](#to-mitigate-these-issues-the-following-actions-are-recommended)
    - [Attachments and Supporting Documents:](#attachments-and-supporting-documents)
    - [Breakdown of the Redis Cluster Dashboard](#breakdown-of-the-redis-cluster-dashboard)
      - [What is the Dashboard?](#what-is-the-dashboard)
      - [Why is it There?](#why-is-it-there)
      - [Why is it Important?](#why-is-it-important)
      - [What are You Looking At?](#what-are-you-looking-at)
      - [What Should You Pay Attention To?](#what-should-you-pay-attention-to)
    - [Breakdown of the NATS Server Dashboard](#breakdown-of-the-nats-server-dashboard)
      - [What is the Dashboard?](#what-is-the-dashboard-1)
      - [Why is it There?](#why-is-it-there-1)
      - [Why is it Important?](#why-is-it-important-1)
      - [What are You Looking At?](#what-are-you-looking-at-1)
      - [What Should You Pay Attention To?](#what-should-you-pay-attention-to-1)
    - [Summary of JMeter Test Reports](#summary-of-jmeter-test-reports)
      - [What is JMeter?](#what-is-jmeter)
      - [Why Use JMeter?](#why-use-jmeter)
      - [What to Look Out For?](#what-to-look-out-for)
    - [Breakdown of the ArangoDB Dashboard](#breakdown-of-the-arangodb-dashboard)
      - [What is the Dashboard?](#what-is-the-dashboard-2)
      - [Why is it There?](#why-is-it-there-2)
      - [Why is it Important?](#why-is-it-important-2)
      - [What are You Looking At?](#what-are-you-looking-at-2)
      - [What Should You Pay Attention To?](#what-should-you-pay-attention-to-2)
    - [Breakdown of the Arango CPU Utilization Graph](#breakdown-of-the-arango-cpu-utilization-graph)
      - [What is the Graph?](#what-is-the-graph)
      - [Why is it There?](#why-is-it-there-3)
      - [Why is it Important?](#why-is-it-important-3)
      - [What are You Looking At?](#what-are-you-looking-at-3)
      - [What Should You Pay Attention To?](#what-should-you-pay-attention-to-3)
    - [Breakdown of the AZURE CPU Utilization Graphs](#breakdown-of-the-azure-cpu-utilization-graphs)
      - [What are the Graphs?](#what-are-the-graphs)
      - [Why are they There?](#why-are-they-there)
      - [Why is it Important?](#why-is-it-important-4)
      - [What are You Looking At?](#what-are-you-looking-at-4)
      - [What Should You Pay Attention To?](#what-should-you-pay-attention-to-4)
    - [Detailed Breakdown of the Graphs](#detailed-breakdown-of-the-graphs)
      - [Graph 1: aks-natsvm-32821002-vmss](#graph-1-aks-natsvm-32821002-vmss)
      - [Graph 2: aks-redisvm-3228634-vmss](#graph-2-aks-redisvm-3228634-vmss)
      - [Graph 3: aks-arangoagent-29738581-vmss](#graph-3-aks-arangoagent-29738581-vmss)
      - [Graph 4: aks-arangococo-21805707-vmss](#graph-4-aks-arangococo-21805707-vmss)
      - [Graph 5: aks-arangodb2-14244936-vmss](#graph-5-aks-arangodb2-14244936-vmss)
      - [Graph 6: aks-crsppool-31592436-vmss](#graph-6-aks-crsppool-31592436-vmss)
      - [Graph 7: aks-tmspool-31166388-vmss](#graph-7-aks-tmspool-31166388-vmss)
      - [Graph 8: aks-tppool-60891139-vmss](#graph-8-aks-tppool-60891139-vmss)
      - [Graph 9: aks-rulespool-2207873-vmss](#graph-9-aks-rulespool-2207873-vmss)
      - [Graph 10: aks-tadppool-2601946-vmss](#graph-10-aks-tadppool-2601946-vmss)
...
- Processing times for read queries were found to be slow, which correlated with high CPU utilization, causing the cluster to max out the CPU resources causing E2E to be extremely slow.
  - **End-to-End (E2E):** Refers to the overall flow of the system from the initial point of input to the final point of output. The reads in the "Rules" stage from ArangoDB are taking a significant amount of time. This delay causes a bottleneck, slowing down subsequent processors that are waiting for the results to come back from the "Rules" stage. Comparisons in rule times can be seen in this document [performance-benchmarking-of-arangodb-single-instance-vs-split-databases-vs-clustering](https://github.com/tazama-lf/docs/blob/main/Technical/Performance-Benchmarking/performance-benchmarking-of-arangodb-single-instance-vs-split-databases-vs-clustering.md) 
...
- There is a suspicion that the indexing strategies used in the clustered deployment of ArangoDB may not be as efficient as those in single-node deployments, possibly contributing to the slow read operations.
  - Extra context regarding the cluster changes needed: [Arango clustering Discussion Outcomes](https://github.com/tazama-lf/docs/blob/main/Technical/Performance-Benchmarking/arango-clustering-discussion-outcomes)
