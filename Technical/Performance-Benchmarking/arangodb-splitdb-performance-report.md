...
- [ArangoDB SplitDB Performance Report](#arangodb-splitdb-performance-report)
  - [Table of Contents](#table-of-contents)
  - [Overview](#overview)
  - [ArangoDB Instances](#arangodb-instances)
  ...
  - [Attachments and Supporting Documents](#attachments-and-supporting-documents)
    - [Analysis of Azure VMS CPU Utilization Graphs](#analysis-of-azure-vms-cpu-utilization-graphs)
      - [What are These Graphs?](#what-are-these-graphs)
      - [Why Are These Graphs Important?](#why-are-these-graphs-important)
      - [What Am I Looking At?](#what-am-i-looking-at)
      - [What Should I Pay Attention To?](#what-should-i-pay-attention-to)
    - [Individual Graph Summaries:](#individual-graph-summaries)
...
- **Differences in ingestion rate through TMS can be seen in the different arango deployments** [performance-benchmarking-of-arangodb-single-instance-vs-split-databases-vs-clustering](https://github.com/tazama-lf/docs/blob/main/Technical/Performance-Benchmarking/performance-benchmarking-of-arangodb-single-instance-vs-split-databases-vs-clustering.md) 
#### 4. Database Scaling
