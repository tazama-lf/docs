...
For our NATS monitoring we’re using the prometheus-nats exporter ([https://github.com/nats-io/prometheus-nats-exporter](https://github.com/nats-io/prometheus-nats-exporter) ) Please note - on our NATS helm chart, this is automatically included with the installation, and you don’t need to deploy your own version.  
...
We use the NATS dashboard with the code : 2279 ([https://grafana.com/grafana/dashboards/2279-nats-servers/](https://grafana.com/grafana/dashboards/2279-nats-servers/))
