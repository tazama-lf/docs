...
| TMS | Event-director | Rule-executer | Typology-processor | TADP | 
| -------- | ------- | ------- | ------- | ------- |
| RAW_HISTORY_DATABASE | | RAW_HISTORY_DATABASE | | RAW_HISTORY_DATABASE |
| RAW_HISTORY_DATABASE_HOST | | RAW_HISTORY_DATABASE_HOST | | RAW_HISTORY_DATABASE_HOST |
| RAW_HISTORY_DATABASE_PORT | | RAW_HISTORY_DATABASE_PORT | | RAW_HISTORY_DATABASE_PORT |
| RAW_HISTORY_DATABASE_USER | | RAW_HISTORY_DATABASE_USER | | RAW_HISTORY_DATABASE_USER |
| RAW_HISTORY_DATABASE_PASSWORD | | RAW_HISTORY_DATABASE_PASSWORD | | RAW_HISTORY_DATABASE_PASSWORD |
| RAW_HISTORY_DATABASE_CERT_PATH | |RAW_HISTORY_DATABASE_CERT_PATH | | RAW_HISTORY_DATABASE_CERT_PATH |
